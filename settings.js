...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "iUhmxRoL#snXQ1n49gBWwpIbphLMjpDH6tc6MmxdfRjQS5IYVi-g", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "923424713060",
DEV: process.env.DEV || "923424713060",
